"""
Django settings for splitgal4db project.
...
STATIC_URL = 'static/' 
STATIC_ROOT = "/var/www/splitgal4.org/static/"
STATICFILES_DIRS = [
    BASE_DIR / "static",
]
...
# Protect password
# From: https://stackoverflow.com/questions/42077532/django-security-and-settings
...
ALLOWED_HOSTS = ['www.splitgal4.org', 'splitgal4.org']
...
WSGI_APPLICATION = 'splitgal4db.wsgi.application'
